...
exchange = CoinbasePro(portfolio_name="my cool portfolio")
strategy = Strategy(exchange)

strategy.add_price_event(rsi_price_event, symbol='BTC-USD', resolution='1h', init=init)
strategy.add_price_event(rsi_price_event, symbol='ETH-USD', resolution='1h', init=init)
